    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                ...
                sh 'rsync -r -e "ssh -i /home/ubuntu/kunal_123.pem" /var/lib/jenkins/workspace/Java_App/Java_App.service ubuntu@10.1.0.131:/home/ubuntu'
                sh 'rsync -r -e "ssh -i /home/ubuntu/kunal_123.pem" /var/lib/jenkins/workspace/Java_App/start.sh ubuntu@10.1.0.131:/home/ubuntu'
